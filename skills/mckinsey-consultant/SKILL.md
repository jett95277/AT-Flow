...
description: 'McKinsey顾问式问题解决系统。从商业问题出发,通过假设驱动的结构化分析方法,生成McKinsey风格研究报告和PPT。融合Problem Solving方法论、MECE原则、Issue Tree拆解、Hypotheses形成、Dummy Page设计、智能数据收集和专业PPT生成能力。中文触发：研究报告 / 竞品分析 / 电梯简报 / 商业分析 / 麦肯锡风格 PPT。'
license: 'MIT'
metadata:
  author: 'Qianru Tian'
  ...
  domain: 'consulting-report'
  source: 'community-fleurytian'
---
